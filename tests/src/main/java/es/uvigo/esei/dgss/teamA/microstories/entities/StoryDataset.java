    ...
    public static Story[] stories() {
        ...
        try {
            return new Story[]{
                    ...
                    new Story(69, formatter.parse("2021-06-01 01:01:01"), "Nulla semper tellus id", "est arcu ac orci. Ut semper pretium neque. Morbi quis urna. Nunc quis arcu", Genre.STORY, Theme.HORROR, Theme.HISTORIC, true),
                    new Story(70, formatter.parse("2021-06-01 01:01:01"), "convallis ligula. Donec luctus", "est arcu ac orci. Ut semper pretium neque. Morbi quis urna. Nunc quis arcu", Genre.NANOSTORY, Theme.HISTORIC, Theme.HISTORIC, true),
                    new Story(71, formatter.parse("2021-06-01 01:01:01"), "neque non quam. Pellentesque", "est arcu ac orci. Ut semper pretium neque. Morbi quis urna. Nunc quis arcu", Genre.NANOSTORY, Theme.HISTORIC, Theme.HISTORIC, true),
                    new Story(72, formatter.parse("2021-06-01 01:01:01"), "Nulla semper tellus id", "a nunc. In at pede. Cras vulputate velit eu sem. Pellentesque ut ipsum ac", Genre.NANOSTORY, Theme.ROMANCE, Theme.HISTORIC, true),
                    new Story(73, formatter.parse("2021-06-01 01:01:01"), "neque. Nullam ut nisi", "est arcu ac orci. Ut semper pretium neque. Morbi quis urna. Nunc quis arcu", Genre.POETRY, Theme.ROMANCE, Theme.HISTORIC, true),
                    new Story(74, formatter.parse("2009-06-01 01:01:01"), "Nulla semper tellus id", "est arcu ac orci. Ut semper pretium neque. Morbi quis urna. Nunc quis arcu", Genre.NANOSTORY, Theme.HISTORIC, Theme.HISTORIC, true),
                    new Story(75, formatter.parse("2009-06-01 01:01:01"), "dictum sapien. Aenean massa.", "netus et malesuada fames ac turpis egestas. Aliquam fringilla cursus purus. Nullam scelerisque neque", Genre.STORY, Theme.CHILD, Theme.HISTORIC, true),
                    new Story(76, formatter.parse("2009-06-01 01:01:01"), "fermentum fermentum arcu. Vestibulum", "est arcu ac orci. Ut semper pretium neque. Morbi quis urna. Nunc quis arcu", Genre.POETRY, Theme.SUSPENSE, Theme.HISTORIC, true),
                    new Story(77, formatter.parse("2009-06-01 01:01:01"), "Nulla semper tellus id", "tristique neque venenatis lacus. Etiam bibendum fermentum metus. Aenean sed pede nec ante blandit", Genre.NANOSTORY, Theme.HORROR, Theme.HISTORIC, true),
                    new Story(78, formatter.parse("2009-06-01 01:01:01"), "enim commodo hendrerit. Donec", "orci. Ut sagittis lobortis mauris. Suspendisse aliquet molestie tellus. Aenean egestas hendrerit neque. In", Genre.NANOSTORY, Theme.HORROR, Theme.HISTORIC, true),
                    new Story(79, formatter.parse("2019-07-01 01:01:01"), "volutpat. Nulla facilisis. Suspendisse", "est arcu ac orci. Ut semper pretium neque. Morbi quis urna. Nunc quis arcu", Genre.POETRY, Theme.HORROR, Theme.HISTORIC, true),
                    new Story(80, formatter.parse("2019-07-01 01:01:01"), "Nulla semper tellus id", "Donec egestas. Duis ac arcu. Nunc mauris. Morbi non sapien molestie orci tincidunt adipiscing.", Genre.STORY, Theme.SUSPENSE, Theme.HISTORIC, true),
                    new Story(81, formatter.parse("2019-07-01 01:01:01"), "Proin dolor. Nulla semper", "est arcu ac orci. Ut semper pretium neque. Morbi quis urna. Nunc quis arcu", Genre.POETRY, Theme.HORROR, Theme.HISTORIC, true),
                    new Story(82, formatter.parse("2014-07-01 01:01:01"), "Nulla semper tellus id", "est arcu ac orci. Ut semper pretium neque. Morbi quis urna. Nunc quis arcu", Genre.POETRY, Theme.HORROR, Theme.HISTORIC, true),
                    new Story(83, formatter.parse("2014-07-01 01:01:01"), "Nam interdum enim non", "est arcu ac orci. Ut semper pretium neque. Morbi quis urna. Nunc quis arcu", Genre.STORY, Theme.SCIENCE_FICTION, Theme.HISTORIC, true),
                    new Story(84, formatter.parse("2014-07-01 01:01:01"), "Nulla semper tellus id", "Donec tincidunt. Donec vitae erat vel pede blandit congue. In scelerisque scelerisque dui. Suspendisse", Genre.STORY, Theme.SUSPENSE, Theme.HISTORIC, true),
                    new Story(85, formatter.parse("2014-07-01 01:01:01"), "Nulla semper tellus id", "est arcu ac orci. Ut semper pretium neque. Morbi quis urna. Nunc quis arcu", Genre.POETRY, Theme.HISTORIC, Theme.HISTORIC, true),
                    new Story(86, formatter.parse("2014-07-01 01:01:01"), "augue ut lacus. Nulla", "est arcu ac orci. Ut semper pretium neque. Morbi quis urna. Nunc quis arcu", Genre.STORY, Theme.SUSPENSE, Theme.HISTORIC, true),
                    new Story(87, formatter.parse("2014-07-01 01:01:01"), "Nulla semper tellus id", "luctus et ultrices posuere cubilia Curae Donec tincidunt. Donec vitae erat vel pede blandit", Genre.STORY, Theme.SUSPENSE, Theme.HISTORIC, true),
                    new Story(88, formatter.parse("2014-07-01 01:01:01"), "lobortis tellus justo sit", "tortor. Nunc commodo auctor velit. Aliquam nisl. Nulla eu neque pellentesque massa lobortis ultrices.", Genre.POETRY, Theme.ROMANCE, Theme.HISTORIC, true),
                    new Story(89, formatter.parse("2014-07-01 01:01:01"), "lorem semper auctor. Mauris", "est arcu ac orci. Ut semper pretium neque. Morbi quis urna. Nunc quis arcu", Genre.POETRY, Theme.HISTORIC, Theme.HISTORIC, true),
                    new Story(90, formatter.parse("2014-07-01 01:01:01"), "Nulla semper tellus id", "Morbi quis urna. Nunc quis arcu vel quam dignissim pharetra. Nam ac nulla. In", Genre.STORY, Theme.ROMANCE, Theme.HISTORIC, true),
                    new Story(91, formatter.parse("2014-07-01 01:01:01"), "Integer eu lacus. Quisque", "est arcu ac orci. Ut semper pretium neque. Morbi quis urna. Nunc quis arcu", Genre.STORY, Theme.HORROR, Theme.HISTORIC, true),
                    new Story(92, formatter.parse("2014-07-01 01:01:01"), "euismod est arcu ac", "fringilla est. Mauris eu turpis. Nulla aliquet. Proin velit. Sed malesuada augue ut lacus.", Genre.NANOSTORY, Theme.SUSPENSE, Theme.HISTORIC, true),
                    new Story(93, formatter.parse("2014-07-01 01:01:01"), "Nulla semper tellus id", "est arcu ac orci. Ut semper pretium neque. Morbi quis urna. Nunc quis arcu", Genre.NANOSTORY, Theme.SUSPENSE, Theme.HISTORIC, true),
                    new Story(94, formatter.parse("2014-07-01 01:01:01"), "Nulla semper tellus id", "est arcu ac orci. Ut semper pretium neque. Morbi quis urna. Nunc quis arcu", Genre.STORY, Theme.HISTORIC, Theme.HISTORIC, true),
                    new Story(95, formatter.parse("2014-07-01 01:01:01"), "Nulla semper tellus id", "amet orci. Ut sagittis lobortis mauris. Suspendisse aliquet molestie tellus. Aenean egestas hendrerit neque.", Genre.NANOSTORY, Theme.CHILD, Theme.HISTORIC, true),
                    new Story(96, formatter.parse("2014-07-01 01:01:01"), "lorem semper auctor. Mauris", "est arcu ac orci. Ut semper pretium neque. Morbi quis urna. Nunc quis arcu", Genre.POETRY, Theme.HISTORIC, Theme.HISTORIC, true),
                    new Story(97, formatter.parse("2014-07-01 01:01:01"), "Nulla semper tellus id", "est arcu ac orci. Ut semper pretium neque. Morbi quis urna. Nunc quis arcu", Genre.POETRY, Theme.HISTORIC, Theme.HISTORIC, true),
                    new Story(98, formatter.parse("2014-07-01 01:01:01"), "Nulla semper tellus id", "est arcu ac orci. Ut semper pretium neque. Morbi quis urna. Nunc quis arcu", Genre.POETRY, Theme.CHILD, Theme.HISTORIC, true),
                    new Story(99, formatter.parse("2014-07-01 01:01:01"), "orci. Ut sagittis lobortis", "est arcu ac orci. Ut semper pretium neque. Morbi quis urna. Nunc quis arcu", Genre.NANOSTORY, Theme.ADVENTURE, Theme.HISTORIC, true),
                    new Story(100, formatter.parse("2014-07-01 01:01:01"), "Curabitur vel lectus. Cum", "est arcu ac orci. Ut semper pretium neque. Morbi quis urna. Nunc quis arcu", Genre.POETRY, Theme.ADVENTURE, Theme.HISTORIC, true),
            };
